    ...
    <section id="about" className="py-28 px-6 relative">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <h2 className="text-3xl sm:text-4xl font-bold text-[var(--text-primary)] mb-6 leading-tight" style={{ fontFamily: "'IBM Plex Sans Arabic', var(--font-sans), system-ui, sans-serif" }}>
              {t.about_title}
            </h2>
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              <div className="card-premium p-6 group relative">
                ...
                <div className="relative flex flex-col items-center z-10">
                  <div className="w-full aspect-square max-h-48 rounded-2xl overflow-hidden border border-[var(--border)] mb-5 group-hover:border-[var(--border-accent)] transition-all duration-300">
                    <Image
                      src="/muaznew.jpeg"
                  ...
                  <div className="w-full text-center">
                    <h3 className="text-lg font-semibold text-[var(--text-primary)] tracking-tight">Muaz Hanout</h3>
                  ...
                  <p className="text-[var(--text-secondary)] text-sm leading-relaxed border-t border-[var(--border)] pt-4 mt-4 text-center max-w-xs">
                    &quot;{t.about_muaz_quote}&quot;
                  </p>
                  <div className="flex items-center gap-3 mt-5">
                    <a
                      ...
                      className="p-2.5 rounded-xl bg-[var(--badge-bg)] border border-[var(--border)] text-[var(--text-muted)] hover:text-[#E4405F] hover:border-[#E4405F]/30 transition-all duration-200"
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="p-2.5 rounded-xl bg-[var(--badge-bg)] border border-[var(--border)] text-[var(--text-muted)] hover:text-[#0A66C2] hover:border-[#0A66C2]/30 transition-all duration-200"
                      aria-label="LinkedIn"
                    >
              ...
              <div className="card-premium p-6 group relative">
                ...
                <div className="relative flex flex-col items-center z-10">
                  ...
                  <div className="w-full text-center">
                    <h3 className="text-lg font-semibold text-[var(--text-primary)] tracking-tight">Omar Gamal</h3>
                    <div className="mt-2 space-y-1">
            ...
            <div className="grid grid-cols-3 gap-4">
              {highlights.map((h, i) => (
                ...
                >
                  <div className="text-xl font-bold text-[var(--text-primary)]">{t[h.valueKey as keyof typeof t]}</div>
