    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        >
          <a
            href="#booking"
            className="group relative px-8 py-4 rounded-xl bg-[#0084FF] text-black font-bold text-base hover:bg-[#0066cc] transition-all duration-200 hover:scale-[1.03] active:scale-95"
          ...
          <a
            href="#services"
            className="px-8 py-4 rounded-xl border border-[rgba(0,132,255,0.2)] text-gray-300 font-medium text-base hover:border-[#00cfff]/40 hover:text-white transition-all duration-200"
          >
            See Our Services
          </a>
        </motion.div>
        ...
        >
          {[
            ...
            <div key={stat.label} className="text-center">
              <div className="text-3xl sm:text-4xl font-black text-[#0084FF] glow-text">
                {stat.value}
              </div>
