  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <motion.div
        ...
        animate="animate"
        className="absolute top-36 right-[10%] hidden lg:flex items-center gap-2 px-4 py-2 rounded-full bg-black border border-[rgba(0,132,255,0.2)] text-xs text-gray-400"
      >
      ...
      <motion.div
        variants={floatVariants}
        animate="animate"
        className="absolute bottom-40 left-[8%] hidden lg:flex items-center gap-2 px-4 py-2 rounded-full bg-black border border-[rgba(0,132,255,0.2)] text-xs text-gray-400"
      >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6">
        <div className="flex flex-col lg:flex-row items-center gap-14">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            >
              <span className="inline-block w-1.5 h-1.5 rounded-full bg-[#0084FF]" />
            ...
            >
              Scale your business{" "}
              <span className="gradient-text">faster with AI Automation</span>{" "}
            ...
            >
              ...
              <div className="p-6 rounded-2xl border border-[rgba(0,132,255,0.2)] bg-[#0a0a0a] hover:border-[#0084FF] transition">
                <h3 className="text-xl font-bold text-white mb-3">🤖 AI Automation</h3>
                <p className="text-gray-400 text-sm leading-relaxed">
                  Automate repetitive tasks, manage workflows, and streamline operations using AI systems.
                </p>
              </div>
              ...
              <div className="p-6 rounded-2xl border border-[rgba(0,132,255,0.2)] bg-[#0a0a0a] hover:border-[#0084FF] transition">
                ...
                <p className="text-gray-400 text-sm leading-relaxed">
                  Grow your brand, attract leads, and convert traffic into customers with data-driven marketing.
                </p>
              </div>
            ...
            >
              <a
                href="#booking"
                className="px-8 py-4 rounded-xl bg-[#0084FF] text-black font-bold hover:bg-[#0066cc] transition hover:scale-[1.03]"
