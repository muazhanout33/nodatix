        ...
        >
          <div className="mobile-scroll">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-base sm:text-lg font-semibold text-[var(--text-primary)] mb-1.5 sm:mb-2" style={{ fontFamily: "'IBM Plex Sans Arabic', var(--font-sans), system-ui, sans-serif" }}>
                {t.hero_card1_title}
              </h3>
