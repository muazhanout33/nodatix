...
const services = [
  {
    ...
    titleKey: "services_s1_title",
    descKey: "services_s1_desc",
    tagKey: "services_s1_tag",
  },
  {
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    titleKey: "services_s2_title",
    descKey: "services_s2_desc",
    tagKey: "services_s2_tag",
  },
  {
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    titleKey: "services_s3_title",
    descKey: "services_s3_desc",
    tagKey: "services_s3_tag",
  },
  {
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    titleKey: "services_s4_title",
    descKey: "services_s4_desc",
    tagKey: "services_s4_tag",
  },
  {
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    titleKey: "services_s5_title",
    descKey: "services_s5_desc",
    tagKey: "services_s5_tag",
  },
  {
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    titleKey: "services_s6_title",
    descKey: "services_s6_desc",
    tagKey: "services_s6_tag",
  },
  {
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    titleKey: "services_s7_title",
    descKey: "services_s7_desc",
    tagKey: "services_s7_tag",
  },
  {
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    titleKey: "services_s8_title",
    descKey: "services_s8_desc",
    tagKey: "services_s8_tag",
  },
];
